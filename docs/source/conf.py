...
project = 'Opentrons API'
copyright = '2016, Opentrons'
author = 'Opentrons'
...
htmlhelp_basename = 'OpentronsAPIdoc'
...
latex_documents = [
    (master_doc, 'OpentronsAPI.tex', 'Opentrons API Documentation',
     'Opentrons', 'manual'),
]
...
man_pages = [
    (master_doc, 'opentronsapi', 'Opentrons API Documentation',
     [author], 1)
]
